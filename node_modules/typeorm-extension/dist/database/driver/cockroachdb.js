...
function createCockroachDBDatabase(driver, connectionOptions, customOptions) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, postgres_1.createSimplePostgresConnection)(driver, connectionOptions, customOptions)];
                case 1:
                    connection = _a.sent();
                    query = "CREATE DATABASE ".concat(customOptions.ifNotExist ? 'IF NOT EXISTS ' : '', " \"").concat(connectionOptions.database, "\"");
                    return [2 /*return*/, executeSimpleCockroachDBQuery(connection, query)];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    connection = _a.sent();
                    query = "DROP DATABASE ".concat(customOptions.ifExist ? 'IF EXISTS ' : '', " \"").concat(connectionOptions.database, "\"");
                    return [2 /*return*/, executeSimpleCockroachDBQuery(connection, query)];
            }
        });
    });
