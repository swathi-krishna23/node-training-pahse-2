...
exports.createDefaultSeederOptions = exports.importSeed = exports.loadFiles = void 0;
var glob_1 = __importDefault(require("glob"));
var path_1 = __importDefault(require("path"));
/* istanbul ignore next */
function loadFiles(filesPattern) {
    return filesPattern
        .map(function (pattern) { return glob_1.default.sync(path_1.default.isAbsolute(pattern) ?
        pattern :
        path_1.default.resolve(process.cwd(), pattern)); })
...
function createDefaultSeederOptions(options) {
...
exports.createDefaultSeederOptions = createDefaultSeederOptions;
